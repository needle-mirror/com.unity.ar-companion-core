...
namespace Unity.AR.Companion.CloudStorage
{
    ...
    public static class CloudStorageMethods
    {
        ...
        public static RequestHandle CloudSaveAsync(this IUsesCloudStorage user, string key, string serializedObject,
            bool showIssueDialog, Action<bool, long, string> callback = null, ProgressCallback progress = null,
            int timeout = CloudStorageDefaults.DefaultTimeout)
        {
            return user.provider.CloudSaveAsync(key, serializedObject, showIssueDialog, callback, progress, timeout);
        }
        ...
        public static RequestHandle CloudSaveAsync(this IUsesCloudStorage user, string key, byte[] bytes,
            ...
            int timeout = CloudStorageDefaults.DefaultTimeout)
        {
            return user.provider.CloudSaveAsync(key, bytes, showIssueDialog, callback, progress, timeout);
        }
        ...
        /// <param name="timeout">The timeout duration (in seconds) for this request</param>
        /// <returns>A handle to the request which can be used to cancel it</returns>
        public static RequestHandle CloudSaveFileAsync(this IUsesCloudStorage user, string key, string path,
            bool showIssueDialog, Action<bool, long, string> callback = null, ProgressCallback progress = null,
            int timeout = CloudStorageDefaults.DefaultTimeout)
        {
            return user.provider.CloudSaveFileAsync(key, path, showIssueDialog, callback, progress, timeout);
        }
        ...
        /// <param name="timeout">The timeout duration (in seconds) for this request</param>
        /// <returns>A handle to the request which can be used to cancel it</returns>
        public static RequestHandle CloudLoadAsync(this IUsesCloudStorage user, string key, bool showIssueDialog, Action<bool, long, string> callback,
            ProgressCallback progress = null, int timeout = CloudStorageDefaults.DefaultTimeout)
        {
            return user.provider.CloudLoadAsync(key, showIssueDialog, callback, progress, timeout);
        }
        ...
        /// <param name="timeout">The timeout duration (in seconds) for this request</param>
        /// <returns>A handle to the request which can be used to cancel it</returns>
        public static RequestHandle CloudLoadAsync(this IUsesCloudStorage user, string key, bool showIssueDialog, Action<bool, long, byte[]> callback,
            ProgressCallback progress = null, int timeout = CloudStorageDefaults.DefaultTimeout)
        {
            return user.provider.CloudLoadAsync(key, showIssueDialog, callback, progress, timeout);
        }
        ...
        /// <param name="timeout">The timeout duration (in seconds) for this request</param>
        /// <returns>A handle to the request which can be used to cancel it</returns>
        public static RequestHandle CloudLoadTextureAsync(this IUsesCloudStorage user, string key, bool showIssueDialog,
            LoadTextureCallback callback, ProgressCallback progress = null, int timeout = CloudStorageDefaults.DefaultTimeout)
        {
            return user.provider.CloudLoadTextureAsync(key, showIssueDialog, callback, progress, timeout);
        }
