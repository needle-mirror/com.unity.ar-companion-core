...
namespace Unity.AR.Companion.CloudStorage
{
    ...
    public interface IProvidesCloudStorage : IFunctionalityProvider
    {
        ...
        RequestHandle CloudSaveAsync(string key, string serializedObject, bool showIssueDialog, Action<bool, long, string> callback = null,
        ...
        /// <param name="timeout">The timeout duration (in seconds) for this request</param>
        /// <returns>A handle to the request which can be used to cancel it</returns>
        RequestHandle CloudSaveFileAsync(string key, string path,  bool showIssueDialog,
        ...
        /// <param name="timeout">The timeout duration (in seconds) for this request</param>
        /// <returns>A handle to the request which can be used to cancel it</returns>
        RequestHandle CloudSaveAsync(string key, byte[] bytes, bool showIssueDialog,
            Action<bool, long, string> callback = null, ProgressCallback progress = null, int timeout = CloudStorageDefaults.DefaultTimeout);
        ...
        /// <param name="timeout">The timeout duration (in seconds) for this request</param>
        /// <returns>A handle to the request which can be used to cancel it</returns>
        RequestHandle CloudLoadAsync(string key, bool showIssueDialog, Action<bool, long, string> callback,
            ProgressCallback progress = null, int timeout = CloudStorageDefaults.DefaultTimeout);
        ...
        /// <param name="timeout">The timeout duration (in seconds) for this request</param>
        /// <returns>A handle to the request which can be used to cancel it</returns>
        RequestHandle CloudLoadAsync(string key, bool showIssueDialog, Action<bool, long, byte[]> callback,
            ProgressCallback progress = null, int timeout = CloudStorageDefaults.DefaultTimeout);
        ...
        /// <param name="timeout">The timeout duration (in seconds) for this request</param>
        /// <returns>A handle to the request which can be used to cancel it</returns>
        RequestHandle CloudLoadTextureAsync(string key, bool showIssueDialog, LoadTextureCallback callback,
            ProgressCallback progress = null, int timeout = CloudStorageDefaults.DefaultTimeout);
