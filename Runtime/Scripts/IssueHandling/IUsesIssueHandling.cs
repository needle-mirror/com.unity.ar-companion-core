...
namespace Unity.AR.Companion.Core
{
    ...
    static class IssueHandlingMethods
    {
        ...
        public static void RaiseIssueRequest(this IUsesIssueHandling user, string issueCode, Exception exception)
        {
            user.provider.RaiseIssueRequest(issueCode, exception);
        }
